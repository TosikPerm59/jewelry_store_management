import os
from product_guide.models import OutgoingInvoice, Jewelry, Manufacturer, Recipient
...
class FileHandler:
    ...
    def parsing_data_object(self):
        if self.file_extension == 'xlsx':
            ...
            if self.invoice_requisites['provider_id'] == 1:
    ...
    def save_outgoing_invoice_object(self):
        ...
        invoice_object.__setattr__('recipient', recipient_obj)
        invoice_object.save()
        print()
